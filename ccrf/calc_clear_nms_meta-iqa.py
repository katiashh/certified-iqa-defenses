...
model = MetricModel(device, '../metaiqa.pth')
...
df = pd.read_csv('res2/nms_meta-iqa.csv')
...
df.to_csv('res2/clear_nms_meta-iqa.csv', index=False)
...
df = pd.read_csv('res2/nms_dn_meta-iqa.csv')
...
df = pd.DataFrame([], columns=['path', 'median', 'lower_b', 'upper_b'])
df.to_csv('res2/clear_nms_dn_meta-iqa.csv', index=False)
