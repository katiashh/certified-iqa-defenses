...
df = pd.read_csv('res2/nms_paq2piq.csv')
...
df.to_csv('res2/clear_nms_paq2piq.csv', index=False)
...
df = pd.read_csv('res2/nms_dn_paq2piq.csv')
...
df = pd.DataFrame([], columns=['path', 'median', 'lower_b', 'upper_b'])
df.to_csv('res2/clear_nms_dn_paq2piq.csv', index=False)
