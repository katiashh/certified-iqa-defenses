...
df = pd.read_csv('res2/nms_maniqa.csv')
...
df.to_csv('res2/clear_nms_maniqa.csv', index=False)
...
df = pd.read_csv('res2/nms_dn_maniqa.csv')
...
df = pd.DataFrame([], columns=['path', 'median', 'lower_b', 'upper_b'])
df.to_csv('res2/clear_nms_dn_maniqa.csv', index=False)
