...
df = pd.read_csv('res2/nms_fpr.csv')
...
df.to_csv('res2/clear_nms_fpr.csv', index=False)
...
df = pd.read_csv('res2/nms_dn_fpr.csv')
...
df = pd.DataFrame([], columns=['path', 'median', 'lower_b', 'upper_b'])
df.to_csv('res2/clear_nms_dn_fpr.csv', index=False)
