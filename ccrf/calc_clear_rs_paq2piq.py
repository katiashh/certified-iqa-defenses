...
df = pd.read_csv('res2/rs_paq2piq.csv')
...
df.to_csv('res2/clear_rs_paq2piq.csv', index=False)
...
df = pd.read_csv('res2/rs_dn_paq2piq.csv')
...
df = pd.DataFrame([], columns=['path', 'pred', 'radius'])
df.to_csv('res2/clear_rs_dn_paq2piq.csv', index=False)
